    ...
    <div class="alert alert-success" id="success_msg" style="display: none;">
       ...
       <form method="POST" id="offerFormUpdate" action="" enctype="multipart/form-data">
            ...
            @csrf
              ...
              <input type="hidden" class="form-control" value="{{$offer->id}}" name="offer_id">


              <div class="form-group">
                <label for="exampleInputEmail1">{{__('messages.add photo')}}</label>
                <input type="file" class="form-control" value="{{$offer->photo}}" name="photo">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$offer->name_ar}}" name="name_ar"  placeholder="Enter Offer Name Arabic">
               ...
               <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$offer->name_en}}" name="name_en"  placeholder="Enter Offer Name English">
              ...
              <div class="form-group form-check">
                ...
                <input type="text" class="form-control" value="{{$offer->details_ar}}" name="details_ar" placeholder="Enter Details Arabic">
                    <small id="details_ar_error" class="form-text text-danger"></small>
              </div>

              <div class="form-group form-check">
                <label class="form-check-label" for="exampleCheck1">{{__('messages.enter details en')}}</label>
                <input type="text" class="form-control" value="{{$offer->details_en}}" name="details_en" placeholder="Enter Details English">
